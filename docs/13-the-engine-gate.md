...
|---|---|---|---|---|---|---|
| `.mesh` assets that are box-only | 23 / 23 | ⚠ 23 / 31 | 24 / 37 | 24 / 39 | **11 / 51** | a game whose meshes are not all boxes |
| — of which `games/atrium` | — | — | 9 / 22 | 9 / 24 | 9 / 24 | (a demo; does not satisfy the target) |
| — of which **`games/warren`** | 13 / 13 | — | 13 / 13 | 13 / 13 ⚠ | **0 / 25** 🟡 | **this is the number that matters** |
...
| 24 | 3 | **`games/warren` stops being boxes.** The vehicle change made concrete: 13 of 13 box meshes and 6 of 6 untextured materials, unchanged across eleven reviews, in the game with the passed design, the fiction, the objective and the milestone attached to it. Everything above lands here once it exists. `docs/11` supplies the direction rather than taste — cast-iron rings, safety orange, warm hand-lamp against cold fittings, pooled light with real dark between | warren | `games/warren`'s tracked measurements move off 13 / 13 and 6 / 6, and a 1920 × 1080 capture of it shows a cast-iron-lined tunnel with pooled cold fittings, real dark between them, a warm hand lamp doing the near work, and a prop that implies somebody was here | 🟡 **built, awaiting verdict — three reviews, and review 16 called the remainder "a near miss with a short, concrete remainder" (s23).** The cell is **12 m of 4.8 m arched bore**, crown 3.2 m; east/west doors are **cross-passages**, ends without doors are **bulkheads**. **13 / 13 → 0 / 25 box meshes.** Review 14 refuted the cheap alternative by arithmetic (34% of every floor unwalkable); review 15 credited the geometry and failed the lighting and materials over it; review 16 credited ten things -- *"it is a tunnel"*, the pitch-up frame as *"the best frame this project has produced"*, real pools with real dark between them, and the warm/cold split at R−B = +22 against G−R = +13 in one frame -- and failed five more, all now landed. **The signs stopped all saying H**: five symmetric stencil letters (H, I, M, O, T -- real admirals, alphabetical) chosen by **grid** distance from the start, so the alphabet advances outward and no seed can put two matching letters side by side, which is a property of the arithmetic rather than of the walk. **The ambient floor was the reason three authored objects rendered at exactly `RGB(0,0,0)`** -- `gloom.rs`'s `LEVEL` 5.0 → 8.0, A/B'd after the critic suspected a metallic material and withdrew. **Roughness and occlusion vary now** rather than being flat to within six levels. **The fitting's cone was a 136° flood** and is narrowed until the deck falls 40 levels in 40 px. **The sign is flag-mounted**, projecting from the wall and legible from both directions -- which is what forced the symmetric alphabet, since mirroring geometry mirrors the letter. All four 1920 × 1080 frames report **0 clipped pixels**. Two of review 16's eight are deliberately open: a second photographable moment (item 31's real close condition), and the warden, which still walks through walls |
