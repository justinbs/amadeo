...
**Gate verdict: NOT POLISHED (review 12).** Phases A and B are closed and passed — A on review 4,
items 8 and 9 on review 5, item 11 on review 6, item 10 on review 7. **Phase C is open and has been
re-planned by review 12**; Phase D is untouched.
