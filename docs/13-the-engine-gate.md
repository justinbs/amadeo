...
| Measurement | Review 1 (s20) | Review 11 claimed | Review 12 | **Review 13 / end of s22** | Target |
|---|---|---|---|---|---|
| `.mesh` assets that are box-only | 23 / 23 | ⚠ 23 / 31 | 24 / 37 | **24 / 39** | a game whose meshes are not all boxes |
| — of which `games/atrium` | — | — | 9 / 22 | 9 / 24 | (a demo; does not satisfy the target) |
| — of which **`games/warren`** | 13 / 13 | — | 13 / 13 | **13 / 13** ⚠ | **this is the number that matters** |
| Material `base_colour_texture` empty | 15 / 15 | 11 / 14 | 11 / 14 | **7 / 14** | a game whose materials sample textures |
| — of which **`games/warren`** | 6 / 6 | — | 6 / 6 | **2 / 6** ✅ | **this is the number that matters** |
| Material `normal_texture` empty | 15 / 15 | 11 / 14 | 11 / 14 | **7 / 14** | ADR 0047 has content in two games now |
| Material `metallic_roughness_texture` empty | 15 / 15 | 11 / 14 | 11 / 14 | **7 / 14** | ADR 0048, likewise |
